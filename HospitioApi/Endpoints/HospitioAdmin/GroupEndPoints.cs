...
namespace HospitioApi.Endpoints.HospitioAdminl;

public class GroupEndPoints : IEndpointsModule
{
    public AppRoute Route { get; init; } = new(
        plural__: "api/hospitio-admin/groups",
        singular: "api/hospitio-admin/group");
