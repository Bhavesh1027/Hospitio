...
{
    public class EditCustomerGuestsCheckInFormBuilderIn
    {
        ...
        public List<EditCustomerGuestsCheckInFormFieldIn> CustomerGuestsCheckInFormFieldIn { get; set; } = new();
    }
    public class EditCustomerGuestsCheckInFormFieldIn
    {
