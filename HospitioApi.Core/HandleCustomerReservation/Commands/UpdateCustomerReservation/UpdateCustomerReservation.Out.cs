...
public class UpdateCustomerReservationOut : BaseResponseOut
{
    public UpdateCustomerReservationOut(string message, UpdatedCustomerReservationOut updatedCustomerReservationOut) : base(message)
    {
