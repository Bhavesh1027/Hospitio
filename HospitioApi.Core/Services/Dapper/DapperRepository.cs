...
namespace HospitioApi.Core.Services.Dapper
{
    public class DapperRepository : IDapperRepository
    {
        ...
        public async Task<List<T>> GetAll<T>(string query, DynamicParameters? sp_params, CancellationToken cancellationToken, CommandType commandType = CommandType.StoredProcedure)
        {
            ...
            using (IDbConnection dbConnection = new SqlConnection(_configuration.GetConnectionString("HospitioConnection")))
            {
        ...
        public async Task<T?> AddSingle<T>(string query, DynamicParameters? sp_params, CancellationToken cancellationToken, CommandType commandType = CommandType.StoredProcedure)
        {
