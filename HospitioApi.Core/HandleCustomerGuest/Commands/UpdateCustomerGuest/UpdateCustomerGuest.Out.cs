...
public class UpdateCustomerGuestOut : BaseResponseOut
{
    public UpdateCustomerGuestOut(string message, UpdatedCustomerGuestOut updatedCustomerGuestOut) : base(message)
    {
