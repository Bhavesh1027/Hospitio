...
public class UpdateCustomerReceptionIn
{
  public UpdateCustomerReceptionCategoryIn CustomerReceptionCategories { get; set; } = new ();
}

public class UpdateCustomerReceptionCategoryIn
{
    ...
    public List<UpdateCustomerReceptionItemIn> CustomerReceptionItems { get; set; } = new List<UpdateCustomerReceptionItemIn>();

}

public class UpdateCustomerReceptionItemIn
{
    public int Id { get; set; }
    public int? CustomerGuestAppBuilderId { get; set; }
