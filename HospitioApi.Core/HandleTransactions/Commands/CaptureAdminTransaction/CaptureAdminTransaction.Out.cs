...
public class CaptureAdminTransactionOut : BaseResponseOut
{
    public CaptureAdminTransactionOut(string message, CapturedAdminTransactionOut captured) : base(message)
    {
        capturedAdminTransactionOut = captured;
    }
    public CapturedAdminTransactionOut capturedAdminTransactionOut { get; set; }
}

public class CapturedAdminTransactionOut
{
