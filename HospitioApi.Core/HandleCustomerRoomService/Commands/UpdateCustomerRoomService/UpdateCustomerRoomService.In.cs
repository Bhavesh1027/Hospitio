...
public class UpdateCustomerRoomServiceIn
{
    public UpdateCustomerRoomServiceCategoryIn UpdateCustomerRoomServiceCategoryIn { get; set; } = new();
}
public class UpdateCustomerRoomServiceCategoryIn
{
    ...
    public List<UpdateCustomerRoomServiceItemIn> CustomerRoomServiceItems { get; set; } = new List<UpdateCustomerRoomServiceItemIn>();

}

public class UpdateCustomerRoomServiceItemIn
{
    public int Id { get; set; }
    public int? CustomerGuestAppBuilderId { get; set; }
    public string? CategoryName { get; set; }
