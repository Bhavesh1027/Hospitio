...
public class GetCustomerEnhanceYourStayByCategoryOut : BaseResponseOut
{
    public GetCustomerEnhanceYourStayByCategoryOut(string message, List<CustomerEnhanceYourStayByCategoryOut> customerEnhanceYourStayCategoriesOut) : base(message)
    {
        CustomersEnhanceYourStayCategoriesOut = customerEnhanceYourStayCategoriesOut;
    }
    public List<CustomerEnhanceYourStayByCategoryOut> CustomersEnhanceYourStayCategoriesOut { get; set; } = new List<CustomerEnhanceYourStayByCategoryOut>();
}
public class CustomerEnhanceYourStayByCategoryOut
{
