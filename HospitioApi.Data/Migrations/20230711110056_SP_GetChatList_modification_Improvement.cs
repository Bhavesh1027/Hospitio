...
{
    public partial class SP_GetChatList_modification_Improvement : Migration
    {
...
BEGIN
	...
	SELECT CT.ChannelId AS [ChatId],CM.[Message] AS LastMessage, CT.LastMessageReadTime AS LastMessageTime ,[FirstName],[LastName],[ProfilePicture],
	...
	AND US.Id <> @UserId
	UNION
	Select [CT].[ChannelId] AS [ChatId],[CM].[Message] AS LastMessage,CT.LastMessageReadTime AS LastMessageTime,[C].[BusinessName] AS [FirstName],NULL AS [LastName],
