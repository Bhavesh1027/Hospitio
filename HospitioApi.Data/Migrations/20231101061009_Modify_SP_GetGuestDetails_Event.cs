...
{
    public partial class Modify_SP_GetGuestDetails_Event : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region SP_GetGuestDetails
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[SP_GetGuestDetails]    Script Date: 1/11/2023 10:06:00 AM ******/
SET ANSI_NULLS ON
GO
...
DECLAre @ChannelId  Int = 0
 Select @ChannelId = IsNULL(CU.ChannelId,0) from Channels C
	...
	If (@ChannelId = 0)	
		...
		END
	Select Distinct CG.Firstname as GuestFirstName, CG.Lastname AS GuestLastName ,CG.Picture as GuestProfile, C.BusinessName as CustomerFirstName, CU.LastName AS CustomerLastName, 
