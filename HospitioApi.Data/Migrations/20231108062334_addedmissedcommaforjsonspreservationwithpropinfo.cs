...
{
    public partial class addedmissedcommaforjsonspreservationwithpropinfo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetCustomerReservationWithCustomerPropInfo]    Script Date: 08-11-2023 11:29:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER               PROCEDURE [dbo].[GetCustomerReservationWithCustomerPropInfo] -- 325,285
(
    @GuestId INT = 0,
    @ReservationId INT = 0
)
