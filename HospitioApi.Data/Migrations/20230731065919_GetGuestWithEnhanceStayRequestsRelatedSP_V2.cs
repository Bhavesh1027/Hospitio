...
{
    public partial class GetGuestWithEnhanceStayRequestsRelatedSP_V2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetGuestWithEnhanceStayRequests]    Script Date: 31-07-2023 11:00:51 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	CASE 
        WHEN GR.[Status] = 1 THEN 'Pending'
        WHEN GR.[Status] = 2 THEN 'Completed'
        ELSE 'Unknown'
    END AS Status
