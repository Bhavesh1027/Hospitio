...
{
    public partial class GetGetQuestionAnswers_SP_V6 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetQuestionAnswers]    Script Date: 14-07-2023 17:21:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/*
	exec [dbo].[GetQuestionAnswers] '',1,10,'','',0,0,0
*/
...
BEGIN
    ...
    AS (SELECT [QA].[Id],
        ...
        WHERE [QA].[DeletedAt] IS NULL
		      ...
		      AND (@IsShowActiveOnly = 0 OR ([QA].[IsActive] = 1))
        ORDER BY CASE
                     WHEN
                     (
                         @SortColumn = 'Name'
