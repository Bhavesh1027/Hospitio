...
{
    public partial class modify_AnonymousChatSp_SP_Get_Communication_CustomerGuest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region SP_Get_Communication_CustomerGuest
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[SP_Get_Communication_CustomerGuest]    Script Date: 28/11/2023 3:55:30 PM ******/
SET ANSI_NULLS ON
GO
