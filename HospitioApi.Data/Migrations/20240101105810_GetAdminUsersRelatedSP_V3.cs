...
{
    public partial class GetAdminUsersRelatedSP_V3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetAdminUsers]    Script Date: 01-01-2024 16:25:23 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN
        ...
        WHERE [DeletedAt] IS NULL AND [IsActive] = 1 AND UserLevelId > 1
    END
	IF @UserLevel = 2
    BEGIN
