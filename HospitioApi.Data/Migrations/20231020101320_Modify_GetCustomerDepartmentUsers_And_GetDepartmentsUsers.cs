...
{
    public partial class Modify_GetCustomerDepartmentUsers_And_GetDepartmentsUsers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region GetCustomerDepartmentUsers
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerDepartmentUsers]    Script Date: 20/10/2023 3:45:43 PM ******/
SET ANSI_NULLS ON
GO
...
END");
            ...
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetDepartmentsUsers]    Script Date: 20/10/2023 3:47:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    AS (SELECT
            (
                ...
                WHERE [DeletedAt] IS NULL
				      AND dp.Id IN ( SELECT G.DepartmentId 
					                 FROM Groups G
									 WHERE G.Id IN ( SELECT U.GroupId FROM Users U ) )
                      AND (
                              [dp].[Name] LIKE '%' + @SearchValue + '%'
                              OR
                              (
