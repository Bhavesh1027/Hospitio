...
{
    public partial class ModifySP_GetCustomerGuestJourneyDetailForSendMessagev2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
/****** Object:  StoredProcedure [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage]    Script Date: 18-01-2024 15:21:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER         PROCEDURE [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage]-- '2024-01-23 07:30:00.280',29
(
...
WHERE 
  ...
  SET @color = ( select Color from CustomerGuestsCheckInFormBuilders where CustomerId = @CustomerId )
