...
{
    public partial class Modify_SP_GetCustomerCustomerUsers_AND_SP_GetCustomerGuestJourneyDetailForSendMessage : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"/****** Object:  StoredProcedure [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage]    Script Date: 11-12-2023 17:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER       PROCEDURE [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage] -- '2023-11-30 01:00:00.000',29
(
...
");
            ...
            migrationBuilder.Sql(@"/****** Object:  StoredProcedure [dbo].[SP_GetCustomer&CustomerUsers]    Script Date: 12-12-2023 10:27:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER     PROCEDURE [dbo].[SP_GetCustomer&CustomerUsers]
AS
BEGIN
    SET NOCOUNT ON
    SET XACT_ABORT ON
	...
	AND [dbo].[CustomerUsers].CustomerLevelId = 1
