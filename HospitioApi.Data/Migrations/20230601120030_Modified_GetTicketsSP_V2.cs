...
{
    public partial class Modified_GetTicketsSP_V2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                                    ...
                                    dbo.Tickets.IsActive, dbo.Tickets.CreatedAt, dbo.CustomerUsers.ProfilePicture,COUNT(*) OVER() as FilteredCount
