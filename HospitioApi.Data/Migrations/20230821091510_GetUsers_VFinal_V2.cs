...
{
    public partial class GetUsers_VFinal_V2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetUsers]    Script Date: 21-08-2023 12:13:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER   PROCEDURE [dbo].[GetUsers] -- 1033,1030,5,1044
(
@DepartmentId INT = 0,
@GroupId INT = 0,
@UserLevelId INT = 0,
