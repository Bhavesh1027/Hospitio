...
{
    public partial class SP_GetChatListCustomer_Final : Migration
    {
...
BEGIN
   ...
   END
	...
	BEGIN
		SELECT	[US].[Id] AS [UserId],CU1.[ChannelId] AS [ChatId],[CM].[Message] AS [LastMessage],[CU1].[LastMessageReadTime] AS [LastMessageTime] ,[FirstName],[LastName],NULL AS [BusinessName],
...
BEGIN
		SELECT	[C].[Id] AS [UserId],[CU1].[ChannelId] AS [ChatId],[CM].[Message] AS [LastMessage],[CU1].[LastMessageReadTime] AS [LastMessageTime],'' AS [FirstName],'' AS [LastName],[C].[BusinessName],
