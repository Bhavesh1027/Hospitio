...
{
    public partial class GetGetQuestionAnswers_SP_V3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetQuestionAnswers]    Script Date: 16-06-2023 18:22:12 ******/
SET ANSI_NULLS ON
GO
    ...
    AS (SELECT [QA].[Id],
        ...
        WHERE [QA].[DeletedAt] IS NULL
			  ...
			  AND (
					  ...
					  OR (
						 @IsViewAll = 0
						 AND CAST([QA].CreatedAt AS DATE) >= CAST(GETDATE() AS DATE)
						 )
                  )
        ORDER BY CASE
                     WHEN
