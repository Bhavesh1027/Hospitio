...
{
    public partial class GetCustomersRelatedSPV2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetCustomers]    Script Date: 31-05-2023 17:42:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER PROCEDURE [dbo].[GetCustomers] -- 'dh',1,2,'','',''
(
    ...
    (
        ...
        WHERE
            ...
            AND (
				...
				OR dbo.CustomerUsers.FirstName LIKE '%' + @SearchValue + '%'
