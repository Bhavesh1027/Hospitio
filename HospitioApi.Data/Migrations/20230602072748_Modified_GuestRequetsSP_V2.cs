...
{
    public partial class Modified_GuestRequetsSP_V2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            //GetGuestRequest SP Modified
            migrationBuilder.Sql(@"
									...
									BEGIN
										...
										CASE WHEN (@SortColumn = 'GuestStatus' AND @SortOrder='ASC')
										THEN dbo.GetGuestsStatus(customerguest.Id)
										END ASC,
                                           
										CASE WHEN (@SortColumn = 'GuestStatus' AND @SortOrder='DESC')
										THEN dbo.GetGuestsStatus(customerguest.Id)
										END DESC
