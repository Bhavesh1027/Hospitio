...
{
    public partial class Create_SP_GetGuestAppBuilder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetGuestAppBuilder]    Script Date: 10/04/2023 7:22:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create OR ALTER  PROCEDURE [dbo].[GetGuestAppBuilder]-- 2
(
	@BuilderId INT = 0
)
AS
