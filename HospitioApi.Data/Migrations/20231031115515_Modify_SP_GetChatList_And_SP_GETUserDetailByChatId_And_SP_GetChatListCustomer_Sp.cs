...
{
    public partial class Modify_SP_GetChatList_And_SP_GETUserDetailByChatId_And_SP_GetChatListCustomer_Sp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region SP_GetChatList
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[SP_GetChatList]    Script Date: 31/10/2023 5:36:31 PM ******/
SET ANSI_NULLS ON
GO
...
END");
            ...
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[SP_GETUserDetailByChatId]    Script Date: 31/10/2023 5:39:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END");
            ...
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[SP_GetChatListCustomer]    Script Date: 31/10/2023 5:38:02 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
