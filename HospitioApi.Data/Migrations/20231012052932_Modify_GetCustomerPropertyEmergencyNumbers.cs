...
{
    public partial class Modify_GetCustomerPropertyEmergencyNumbers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region GetCustomerPropertyEmergencyNumbers
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerPropertyEmergencyNumbers]    Script Date: 10/12/2023 10:18:35 AM ******/
SET ANSI_NULLS ON
GO
...
END");
			...
			migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerPropertyExtras]    Script Date: 10/12/2023 10:11:43 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
