...
{
    public partial class Modify_GetCustomerGuests_For_Set_GuestStatus_In_Ascending_Order : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region GetCustomerGuests
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerGuests]    Script Date: 23/05/2024 6:01:33 PM ******/
SET ANSI_NULLS ON
GO
