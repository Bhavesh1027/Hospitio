...
{
    public partial class SpGetAlertMessageModifyforMsgReqType : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
/****** Object:  StoredProcedure [dbo].[GetAlertMessages]    Script Date: 05-02-2024 15:37:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE OR ALTER   PROCEDURE [dbo].[GetAlertMessages] --'2024-02-05 12:20:03.273'
(
...
@OfficeHoursMsg nvarchar(max),
@OfficeHoursMsgWaitTimeInMinutes int,
@OfflineHourMsg nvarchar(max),
...
BEGIN
    ...
    INTO @ChannelId, @ReceiverType, @ReceiverId, @Source, @LastMessageSendingTime, @LastMessage,@MsgReqType;
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    INSERT INTO #TempTables ([AlertMessage], [ChatId], [Minute], [LastMessageSendingTime], [LastMessage], [AlertType], [ReceiverId], [ReceiverType], [Platform], [NameOfStaffPerson], [SenderId], [SenderType],[MsgReqType])
                    VALUES (@OfficeHoursMsg, @ChannelId, @OfficeHoursMsgWaitTimeInMinutes, @LastMessageSendingTime, @LastMessage, 'CustomerGuestAlert', @ReceiverId, @ReceiverType, NULL, NULL, @SenderId, @SenderType,@MsgReqType);
                END
            END
            ELSE
            BEGIN
                ...
                BEGIN
                    ...
                    BEGIN
                        INSERT INTO #TempTables ([AlertMessage], [ChatId], [Minute], [LastMessageSendingTime], [LastMessage], [AlertType], [ReceiverId], [ReceiverType], [Platform], [NameOfStaffPerson], [SenderId], [SenderType],[MsgReqType])
                        VALUES (@OfflineHourMsg, @ChannelId, @OfflineHoursMsgWaitTimeInMinutes, @LastMessageSendingTime, @LastMessage, 'CustomerGuestAlert', @ReceiverId, @ReceiverType, NULL, NULL, @SenderId, @SenderType,@MsgReqType);
                    END
                END
            END
        END
...
DECLARE @CustomerUsersId int,
		...
		@Platform int,
		@PhoneNumber2 nvarchar(max),
		@PhoneCountry2 nvarchar(max),
		@Minutes int,
		@Msg nvarchar(max),
		@ChannelId4 int,
		...
		@CreatedAt4 DateTime,
		@diffinminute4 int,
		@NameOfCustomerStaff nvarchar(max),
		@CustomerPhoneNumber nvarchar(max),
		@customerAppId nvarchar(max),
		@customerAppPrivateKey nvarchar(max),
		@CustomerId2 nvarchar(max);
