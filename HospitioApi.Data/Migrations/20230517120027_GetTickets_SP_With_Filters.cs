...
{
    public partial class GetTickets_SP_With_Filters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
CREATE OR ALTER PROCEDURE [dbo].[GetTicketsV2] 
(
@CategoryId int=0,
@Status int=0,
@Priority int=0,
...
SELECT dbo.Tickets.Id,dbo.Tickets.CustomerId,dbo.Customers.BusinessName,dbo.Customers.Cname as CustomerName, dbo.Tickets.Title, dbo.Tickets.Details, dbo.Tickets.Priority, 
...
/****** Object:  StoredProcedure [dbo].[GetTickets]    Script Date: 22-05-2023 18:37:54 ******/
SET ANSI_NULLS ON
GO
...
dbo.Tickets.Duedate, dbo.Tickets.Status, dbo.Tickets.CloseDate, dbo.Tickets.CreatedFrom,
Isnull(dbo.Users.FirstName,'') + ' ' + Isnull(dbo.Users.LastName,'') as CSAgentName, 
dbo.TicketCategorys.CategoryName as TicketCategoryName,dbo.Customers.Email
FROM dbo.Tickets WITH (NOLOCK) 
INNER JOIN dbo.TicketCategorys WITH (NOLOCK) ON dbo.Tickets.TicketCategoryId = dbo.TicketCategorys.Id 
INNER JOIN dbo.Users WITH (NOLOCK) ON dbo.Tickets.CSAgentId = dbo.Users.Id 
INNER JOIN dbo.Customers WITH (NOLOCK) ON dbo.Tickets.CustomerId = dbo.Customers.Id
