...
{
    public partial class Modify_Sp_GetCustomerForHospitioAdmin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region GetCustomerForHospitioAdmin
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerForHospitioAdmin]    Script Date: 11/20/2023 7:06:31 PM ******/
SET ANSI_NULLS ON
GO
...
");
            ...
            #region GetCustomer
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomer]    Script Date: 11/20/2023 7:17:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
