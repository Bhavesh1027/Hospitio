...
{
    public partial class ModifySPofsendGuestjourneyMEssage : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
/****** Object:  StoredProcedure [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage]    Script Date: 29-11-2023 18:41:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE OR ALTER   PROCEDURE [dbo].[SP_GetCustomerGuestJourneyDetailForSendMessage] -- '2023-11-30 01:00:00.000',29
(
