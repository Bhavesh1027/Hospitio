...
{
    public partial class Modify_GetCustomer_And_GetCustomerForHospitioAdmin_SP_For_Get_CheckInPolicy_And_CheckOutPolicy_Column_V2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            #region GetCustomer
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomer]    Script Date: 24-05-2024 16:41:24 ******/
SET ANSI_NULLS ON
GO
...
FOR JSON PATH )");
            ...
            migrationBuilder.Sql(@"GO
/****** Object:  StoredProcedure [dbo].[GetCustomerForHospitioAdmin]    Script Date: 24-05-2024 16:51:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
