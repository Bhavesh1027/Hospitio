...
{
    public partial class GetCustomersEnhanceYourStayRelatedSPV3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
GO
/****** Object:  StoredProcedure [dbo].[GetCustomersEnhanceYourStay]    Script Date: 14-06-2023 10:48:09 ******/
SET ANSI_NULLS ON
GO
...
FROM CustomerGuestAppEnhanceYourStayCategories m where m.DeletedAt is null and m.CustomerGuestAppBuilderId = @BuilderId 
 ORDER BY
