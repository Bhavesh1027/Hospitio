...
public partial class CustomerGuestAppHousekeepingItem : Auditable
{
    public CustomerGuestAppHousekeepingItem()
    {
    ...
    public virtual CustomerGuestAppHousekeepingCategory? CustomerGuestAppHousekeepingCategory { get; set; }
