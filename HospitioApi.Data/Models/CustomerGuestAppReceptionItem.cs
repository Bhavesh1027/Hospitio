...
public partial class CustomerGuestAppReceptionItem : Auditable
{
    public CustomerGuestAppReceptionItem()
    {
    ...
    public virtual CustomerGuestAppReceptionCategory? CustomerGuestAppReceptionCategory { get; set; }
