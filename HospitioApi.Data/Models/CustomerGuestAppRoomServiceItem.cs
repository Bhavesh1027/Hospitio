...
public partial class CustomerGuestAppRoomServiceItem : Auditable
{
    public CustomerGuestAppRoomServiceItem()
    {
    ...
    public virtual CustomerGuestAppRoomServiceCategory? CustomerGuestAppRoomServiceCategory { get; set; }
