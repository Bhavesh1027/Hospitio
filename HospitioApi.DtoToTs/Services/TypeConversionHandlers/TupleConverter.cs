...
internal class TupleConverter : TypeConversionHandler
{
    ...
    public override TypeNode Handle(TypeSyntax type)
    {
        ...
        {
            return new Models.TypeNodes.Tuple(
                elements: tuple.Elements.Select((element, index) => new Models.TypeNodes.Tuple.Element(
        ...
        {
            return new Models.TypeNodes.Tuple(
                elements: generic.TypeArgumentList.Arguments.Select((argument, index) => new Models.TypeNodes.Tuple.Element(
                    name: Name(index),
