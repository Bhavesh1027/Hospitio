namespace CSharpToTypeScript.Core.Options
{
    public class CodeConversionOptions : ModuleNameConversionOptions
    {
        public CodeConversionOptions(bool export, bool useTabs, int? tabSize = null,
            ...
            bool toCamelCase = true, bool removeInterfacePrefix = false, ImportGenerationMode importGenerationMode = ImportGenerationMode.None,
            bool useKebabCase = false, bool appendModelSuffix = true, QuotationMark quotationMark = QuotationMark.Double,
